...
public class CopyOfMyImageView extends ImageView {
	...
	public CopyOfMyImageView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		camera = new Camera();
	}

	public CopyOfMyImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		camera = new Camera();
	}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			if (isScale) {//点击图片中间部分，会多产生一次点击操作，故而屏蔽掉
