...
public class CoverFlow extends Gallery {
	//mCamera是用来做�?D效果处理,比如z轴方向上的平�?绕y轴的旋转�?
	private Camera mCamera = new Camera();
	//是图片绕y轴最大旋转角�?也就是屏幕最边上那两张图片的旋转角度
	private int mMaxRotationAngle = 50;//60;
	//mMaxZoom是图片在z轴平移的距离,视觉上看起来就是放大缩小的效�?
	...
	/**
	 * 这就是所谓的在大小的布局�?这一观点已经发生了改变�?如果 你只是添加到视图层次,有人叫你旧的观念 价�?观为0�?
	 * 
	 * @param w
