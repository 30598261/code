...
public class WifiAdmin {
	...
	public boolean isExsitsTest(String paramString) {
		
		mWifiManager = this.mWifiManager;  
        String destStr = "\""+paramString+"\"";  
        Log.i("test", "existingConfig destStr = "+destStr);  
        Log.d("test", "mWifiManager ="+mWifiManager);  
        ...
        if(existingConfigs==null){  
           ...
           {    
                 System.out.println( "existingConfig ssid = "+existingConfig.SSID);  
             if (existingConfig.SSID.equalsIgnoreCase(destStr))    
             {    
                 System.out.println( "existingConfig contain ssid = "+existingConfig.SSID);  
...
*/
	...
	public boolean createWiFiAP(WifiConfiguration paramWifiConfiguration,
	...
	public String getApSSID() {
		try {
			...
			{	//System.out.println(" pwd1 : "+localWifiConfiguration.preSharedKey);
		...
		//	System.out.println(" pwd2 : "+localWifiConfiguration.wepKeys[0]);
			return str;
		} catch (Exception localException) {
		}
		return null;
	...
	public String getApPwd() {
		try {
			...
			if (localWifiConfiguration.SSID != null)
			{
				return localWifiConfiguration.preSharedKey;
			}
			Field localField1 = WifiConfiguration.class.getDeclaredField("mWifiApProfile");
			if (localField1 == null)
				return null;
